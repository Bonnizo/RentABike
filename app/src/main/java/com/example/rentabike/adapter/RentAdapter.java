...
public class RentAdapter extends RecyclerView.Adapter<RentAdapter.RentHolder> implements Filterable {
    ...
    class RentHolder extends RecyclerView.ViewHolder {
        ...
        public RentHolder(View itemView) {
            ...
            buttonShowBike = itemView.findViewById(R.id.button_show_rentedBike);
            buttonShowBike.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View v) {

                    int position = getAdapterPosition();
                    if (listener != null & position != RecyclerView.NO_POSITION) {
                        listener.showBikeRented(rentEntities.get(position));
                    }
                }
            });
    ...
    public interface OnItemClickListener {
        ...
        void showBikeRented(RentEntity rent);
    }
