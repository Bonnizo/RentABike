...
public class RentViewModel extends AndroidViewModel {
    ...
    public void insert(RentEntity rent){ repository.insert(rent); }
    public void update(RentEntity rent){repository.update(rent); }
    public void delete(RentEntity rent){ repository.delete(rent);}
    public LiveData<List<RentEntity>>getAllrents(){return allrents;}
}
