...
public class BikeViewModel extends AndroidViewModel {
    ...
    public void update(BikeEntity bike){repository.update(bike); }
    public void delete(BikeEntity bike){ repository.delete(bike);}
    public void deleteAllBikes(){ repository.deleteAllBikes();}
    public LiveData<List<BikeEntity>>getAllbikes(){return allBikes;}
}